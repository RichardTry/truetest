...
minetest.register_node("crafting:wood_work_bench", {
	description = "Wood Work Bench",
	groups = { snappy = 1 },
...
minetest.register_node("crafting:stone_work_bench", {
	description = "Stone Work Bench",
	groups = { snappy = 1 },
	on_rightclick = crafting.make_on_rightclick("inv", 2, { x = 8, y = 3 }),
	tiles = {"xdecor_workbench_top.png",   "xdecor_workbench_top.png",
		 "xdecor_workbench_sides.png", "xdecor_workbench_sides.png",
